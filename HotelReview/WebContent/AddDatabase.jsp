...
<div id="main">
 ...
 <form name="frmLogin" onSubmit="return validate();" action="AddDbServlet" method="post" >
     
    
  
   
   
    <br><br><center><input type="submit" value="Add"  style="height:25px; width:70px;" id="Sub"/></center>
